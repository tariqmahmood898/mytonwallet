...
package org.mytonwallet.app_air.uicomponents.widgets.recyclerView;
...
public class CustomItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    OnItemTouchListener mExternalTouchListener;
    BeforeLongPressListener beforeLongPressListener;
    /**
     ...
     */
    public CustomItemTouchHelper(@NonNull Callback callback) {
        mCallback = callback;
    }
    ...
    void moveIfNecessary(ViewHolder viewHolder) {
        ...
        Log.d(TAG, "MOVE IF NECESSARY HERE...");
    ...
    public void injectTouchInterceptEvent(MotionEvent downEvent) {
        mOnItemTouchListener.onInterceptTouchEvent(mRecyclerView, downEvent);
    }

    public void injectTouchEvent(MotionEvent downEvent) {
        mOnItemTouchListener.onTouchEvent(mRecyclerView, downEvent);
    }
    ...
    public void setExternalTouchListener(RecyclerView.OnItemTouchListener listener) {
        mExternalTouchListener = listener;
    }

    public void setBeforeLongPressListener(BeforeLongPressListener listener) {
        beforeLongPressListener = listener;
    }
    ...
    public interface BeforeLongPressListener {
        void longPressed();
    }
    ...
    public abstract static class Callback {
        ...
        public static ItemTouchUIUtil getDefaultUIUtil() {
            return CustomItemTouchUIUtilImpl.INSTANCE;
        }
        ...
        public void onSelectedChanged(@Nullable ViewHolder viewHolder, int actionState) {
            if (viewHolder != null) {
                CustomItemTouchUIUtilImpl.INSTANCE.onSelected(viewHolder.itemView);
            }
        }
         ...
         * as calling {@link androidx.recyclerview.widget.LinearLayoutManager#scrollToPositionWithOffset(int, int)}.
         * <p>
        ...
        public void clearView(@NonNull RecyclerView recyclerView, @NonNull ViewHolder viewHolder) {
            CustomItemTouchUIUtilImpl.INSTANCE.clearView(viewHolder.itemView);
        }
        ...
        public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
            ...
            CustomItemTouchUIUtilImpl.INSTANCE.onDraw(c, recyclerView, viewHolder.itemView, dX, dY,
                actionState, isCurrentlyActive);
        }
        ...
        public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
                                    ViewHolder viewHolder,
                                    float dX, float dY, int actionState, boolean isCurrentlyActive) {
            CustomItemTouchUIUtilImpl.INSTANCE.onDrawOver(c, recyclerView, viewHolder.itemView, dX, dY,
                actionState, isCurrentlyActive);
        }
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (beforeLongPressListener != null)
                beforeLongPressListener.longPressed();
    ...
    private final OnItemTouchListener mOnItemTouchListener = new OnItemTouchListener() {
        ...
        public void onTouchEvent(@NonNull RecyclerView recyclerView, @NonNull MotionEvent event) {
            if (mExternalTouchListener != null)
                mExternalTouchListener.onTouchEvent(recyclerView, event);
            mGestureDetector.onTouchEvent(event);
            if (DEBUG) {
                Log.d(TAG,
